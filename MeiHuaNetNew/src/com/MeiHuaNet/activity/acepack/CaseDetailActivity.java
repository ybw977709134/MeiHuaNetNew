...
public class CaseDetailActivity extends DetailBaseActivity {
	...
	protected void setBodyContent() {
		knowledgeObject = (KnowledgeObject) getIntent().getSerializableExtra(
				"detailObject");
	...
	protected void requestData() {
		...
		params.methodName = Constants.GetCaseDetail;
