	...
	public static class Builder {
		...
		public CustomDialog create() {
			...
			final CustomDialog dialog = new CustomDialog(context,
					R.style.Dialog);
			final View layout = inflater.inflate(R.layout.layout_dialog, null);
						...
						.setOnClickListener(new View.OnClickListener() {
							public void onClick(View v) {
								if (positiveButtonClickListener != null) {
									...
									// if no listener . default dismiss the
									// dialog
									dialog.dismiss();
								}
							}
			...
			//设置对话框两边距离屏幕的距离。不设置会在横向上占满屏幕
			layout.getViewTreeObserver().addOnGlobalLayoutListener(
					new OnGlobalLayoutListener() {

						@Override
						public void onGlobalLayout() {
							LinearLayout layouts = (LinearLayout) layout
									.findViewById(R.id.dialog_all_layout);
							Display d = dialog.getWindow().getWindowManager()
									.getDefaultDisplay();
							int screenWidth = d.getWidth();
							layouts.getLayoutParams().width = screenWidth
									- DensityUtil.dip2px(dialog.getContext(),
											60);
